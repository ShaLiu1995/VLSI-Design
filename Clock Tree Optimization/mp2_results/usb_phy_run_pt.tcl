...
PtReportTiming > ${design}_before_opt.rpt

source opt.tcl

PtReportTiming > ${design}_after_opt.rpt
PtReportMetric2 > ${design}_metric2_opt.rpt

write_changes -format ptsh -out ${design}_cell.sizes  
