...
set_log_file /home/linux/ieng6/ee260b/shl237/lab6/run_siliconsmart/LIB_FF_1.1_-40_ALL/temp/sis.shl237.[pid].log
set_log_level info
...
if { [catch {exec mv -f /home/linux/ieng6/ee260b/shl237/lab6/run_siliconsmart/LIB_FF_1.1_-40_ALL/temp/sis.shl237.[pid].log /home/linux/ieng6/ee260b/shl237/lab6/run_siliconsmart/LIB_FF_1.1_-40_ALL/runtime/cdpl/sis.W$::env(CDPL_WORKERID).[get_hostname].[pid].log} mv_err] } {
  log_warning $mv_err
}
set_log_file /home/linux/ieng6/ee260b/shl237/lab6/run_siliconsmart/LIB_FF_1.1_-40_ALL/runtime/cdpl/sis.W$::env(CDPL_WORKERID).[get_hostname].[pid].log
exit 0
}
