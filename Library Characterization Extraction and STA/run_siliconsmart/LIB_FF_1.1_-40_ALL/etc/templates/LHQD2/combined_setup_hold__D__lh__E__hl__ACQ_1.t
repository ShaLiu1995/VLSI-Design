...
## 
## Test combined_setup_hold__D__lh__E__hl
set tempTest [ SBTest "combined_setup_hold__D__lh__E__hl" ]
$tempTest setTargets { combined_setup_hold__D__lh__E__hl }
...
"initial_delay+1*units-setup+(width+slew_D*3)/2-slew_E*1.199857+(2.5e-10)"     { in2 } {   0    -    -     }
                                  "initial_delay+1*units-setup+width-hold"     { in3 } {   -    0    0     }
...
$tempWT bindInterface { Q E D } { cell_initial_delay E[cycle_time] E[cycle_time] E[default_slew] 1e-11 None 0.0 0.0 Q[logic_high_threshold_rise] D[constraint_resolution] D[dependent_max_width] }
