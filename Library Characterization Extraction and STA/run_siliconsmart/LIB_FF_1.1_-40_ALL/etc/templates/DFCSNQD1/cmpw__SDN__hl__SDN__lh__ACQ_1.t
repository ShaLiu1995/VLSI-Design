...
## 
## Test cmpw__SDN__hl__SDN__lh
set tempTest [ SBTest "cmpw__SDN__hl__SDN__lh" ]
$tempTest setTargets { cmpw__SDN__hl__SDN__lh }
...
$tempWT setStimulus                                              {   SDN  CP   CDN  D    Q     } {
                           ...
                           "initial_delay+0.5*units"          {} {   -    -    1    -    -     }
                             "initial_delay+1*units" { in1 out } {   0    -    -    -    1     }
           "(initial_delay+1*units)+cmpw+slew_SDN*3"     { in2 } {   1    -    -    -    -     }
"((initial_delay+1*units)+cmpw+slew_SDN*3)+(stable)"          {} {   -    -    -    -    -     }
}

$tempWT addMeasurements {} {
  { tin_SDN              Tin        { SDN in1 } NO_USER SYS }
  { cmpw_SDN             cmpw       { SDN in1 SDN in2 } NO_USER SYS }
  { tout_Q               Tout       { Q in1 } NO_USER SYS }
  { delay_SDN_Q          delay      { SDN in1 Q in1 } NO_USER SYS }
  { fallback_Q           fallback   { Q in1 0 } NO_USER SYS }
}

$tempWT addOptimization    cmpw    min_cmpw    max_cmpw    delay_SDN_Q    { cmpw_SDN tin_SDN tin_SDN tout_Q delay_SDN_Q } { fallback_Q } {  } {  } expand None opt_tolerance None None max_cmpw "1"
$tempWT bindInterface { Q SDN CP CDN D } { cell_initial_delay SDN[cycle_time] SDN[cycle_time] SDN[default_slew] max(SDN[stable_time],Q[stable_time]) SDN[max_cmpw] SDN[min_cmpw] SDN[max_cmpw] SDN[constraint_resolution] }
