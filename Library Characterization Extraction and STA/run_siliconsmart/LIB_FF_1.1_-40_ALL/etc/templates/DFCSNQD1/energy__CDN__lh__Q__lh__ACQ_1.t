...
## 
## Test energy__CDN__lh__Q__lh
set tempTest [ SBTest "energy__CDN__lh__Q__lh" ]
$tempTest setTargets { energy__CDN__lh__Q__lh cap_energy__Q__lh energy1__CDN__lh__Q__lh__vdd energy1__CDN__lh__Q__lh__vss leakage_power1__vdd leakage_power1__vss leakage_power2__vdd leakage_power2__vss }
...
$tempWT setStimulus                            {   SDN  CP   CDN  D    Q     } {
                             "0"            {} {   0    0    1    0    0     }
                 "initial_delay"            {} {   -    -    0    -    -     }
       "initial_delay+0.5*units" { start out } {   -    -    1    -    1     }
...
$tempWT addMeasurements {} {
  ...
  { energy__CDN__lh__Q__lh energy     { start pp energy_change_threshold energy_change_abs_threshold 0 } NO_USER SYS }
  { energy1__CDN__lh__Q__lh__vdd energy1    { start pp energy_change_threshold energy_change_abs_threshold 0 vdd } }
  ...
  { energy1__CDN__lh__Q__lh__vss energy1    { start pp energy_change_threshold energy_change_abs_threshold 0 vss } }
...
$tempWT bindInterface { Q SDN CP CDN D } { cell_initial_delay CDN[cycle_time] CDN[cycle_time] CDN[default_slew] cell_power_period power_stabilization_threshold power_stabilization_threshold_absolute }
