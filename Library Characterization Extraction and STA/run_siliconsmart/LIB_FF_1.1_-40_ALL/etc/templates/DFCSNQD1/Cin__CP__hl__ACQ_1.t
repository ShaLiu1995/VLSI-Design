...
## 
## Test Cin__CP__hl
set tempTest [ SBTest "Cin__CP__hl" ]
$tempTest setTargets { Cin__CP__hl }
...
$tempWT setStimulus                      {   SDN  CP   CDN  D    Q     } {
       ...
       "initial_delay+0.5*units"      {} {   1    -    -    -    -     }
         "initial_delay+1*units"      {} {   -    1    -    -    0     }
       "initial_delay+1.5*units" { in1 } {   -    0    -    -    0     }
"(initial_delay+1.5*units)+(pp)"      {} {   -    -    -    -    -     }
}

$tempWT addMeasurements {} {
  { cin_CP               Cin        { CP in1 } NO_USER SYS }
}

$tempWT bindInterface { Q SDN CP CDN D } { cell_initial_delay CP[cycle_time] CP[cycle_time] CP[default_slew] cell_power_period }
$tempAcq addWaveTable $tempWT
release_obj $tempWT
$tempAcq setRelatedAcq "delay__CP__lh__Q__hl__ACQ_1"
