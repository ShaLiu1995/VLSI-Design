...
## 
## Test energy__CP__hl
set tempTest [ SBTest "energy__CP__hl" ]
$tempTest setTargets { energy__CP__hl Cin__CP__hl energy1__CP__hl__vdd energy1__CP__hl__vss leakage_power1__vdd leakage_power1__vss leakage_power2__vdd leakage_power2__vss }
...
$tempAcq setState "!D&!CDN&!SDN&!Q"
$tempAcq setStateCoverage "1"
$tempAcq setAdditionalStateCoverage "1" "Cin__CP__hl"
$tempAcq setWhen "1"
...
$tempWT setStimulus                        {   SDN  CP   CDN  D    Q     } {
                             "0"        {} {   0    0    0    0    0     }
                 "initial_delay"        {} {   -    1    -    -    -     }
       "initial_delay+0.5*units" { start } {   -    0    -    -    -     }
...
$tempWT addMeasurements {} {
  ...
  { energy__CP__hl       energy     { start pp energy_change_threshold energy_change_abs_threshold 0 } NO_USER SYS }
  { energy1__CP__hl__vdd energy1    { start pp energy_change_threshold energy_change_abs_threshold 0 vdd } }
  ...
  { energy1__CP__hl__vss energy1    { start pp energy_change_threshold energy_change_abs_threshold 0 vss } }
...
$tempWT bindInterface { Q SDN CP CDN D } { cell_initial_delay CP[cycle_time] CP[cycle_time] CP[default_slew] cell_power_period power_stabilization_threshold power_stabilization_threshold_absolute }
