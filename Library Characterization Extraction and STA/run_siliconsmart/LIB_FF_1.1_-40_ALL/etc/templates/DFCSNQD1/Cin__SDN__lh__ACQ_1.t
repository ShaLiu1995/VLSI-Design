...
## 
## Test Cin__SDN__lh
set tempTest [ SBTest "Cin__SDN__lh" ]
$tempTest setTargets { Cin__SDN__lh }
...
$tempWT setStimulus                      {   SDN  CP   CDN  D    Q     } {
       ...
       "initial_delay+0.5*units"      {} {   -    -    1    -    -     }
         "initial_delay+1*units"      {} {   0    -    -    -    1     }
       "initial_delay+1.5*units" { in1 } {   1    -    -    -    1     }
"(initial_delay+1.5*units)+(pp)"      {} {   -    -    -    -    -     }
}

$tempWT addMeasurements {} {
  { cin_SDN              Cin        { SDN in1 } NO_USER SYS }
}

$tempWT bindInterface { Q SDN CP CDN D } { cell_initial_delay SDN[cycle_time] SDN[cycle_time] SDN[default_slew] cell_power_period }
$tempAcq addWaveTable $tempWT
release_obj $tempWT
$tempAcq setRelatedAcq "delay__SDN__hl__Q__lh__ACQ_1"
