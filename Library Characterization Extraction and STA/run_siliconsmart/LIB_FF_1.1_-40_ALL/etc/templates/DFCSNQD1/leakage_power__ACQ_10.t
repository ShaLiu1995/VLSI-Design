...
## 
## ACQ_10
set tempAcq [ SBLeakageCurrentAcquisition "ACQ_10" ]
$tempAcq setHarnessName default
$tempAcq setAcquire 1
$tempAcq setState "!D&CDN&SDN&!CP&!Q"
$tempAcq setStateCoverage "CDN&!CP&!D&SDN"
$tempAcq setWhen "CDN !CP !D SDN"
$tempAcq addSweptState {CP 0 D 0 SDN 1} {CDN&!CP&!D&SDN} {CDN !CP !D SDN}
$tempAcq addSweptState {CP 0 D 1 SDN 1} {CDN&!CP&D&SDN} {CDN !CP D SDN}
$tempAcq addSweptState {CP 1 D 0 SDN 1} {CDN&CP&!D&SDN} {CDN CP !D SDN}
$tempAcq addSweptState {CP 1 D 1 SDN 1} {CDN&CP&D&SDN} {CDN CP D SDN}
...
$tempWT setStimulus                                   {   SDN  CP   CDN  D    Q     } {
                                        "0"   { in0 } {   1    0    0    0    0     }
                            "initial_delay"   { in1 } {   -    -    1    -    -     }
   "(initial_delay)+initial_delay+(1.0*pp)" { start } {   -    -    1    -    0     }
"(initial_delay)+initial_delay+(1.0*pp)+pp"   { end } {   -    -    1    -    0     }
}

$tempWT addMeasurements {} {
  { leakage_current      leakage_power { (initial_delay)+initial_delay+(1.0*pp) (initial_delay)+initial_delay+(1.0*pp)+pp {CDN D SDN CP} {} } NO_USER SYS }
}
