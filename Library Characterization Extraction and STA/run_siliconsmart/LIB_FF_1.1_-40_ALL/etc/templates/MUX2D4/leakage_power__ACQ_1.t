...
$tempAcq addSweptState {I0 0 I1 0 S 0} {!I0&!I1&!S} {!I0 !I1 !S}
$tempAcq addSweptState {I0 0 I1 0 S 1} {!I0&!I1&S} {!I0 !I1 S}
$tempAcq addSweptState {I0 0 I1 1 S 0} {!I0&I1&!S} {!I0 I1 !S}
$tempAcq addSweptState {I0 1 I1 0 S 1} {I0&!I1&S} {I0 !I1 S}
...
$tempWT setStimulus                       {   I1   I0   S    Z     } {
                            "0"   { in0 } {   0    0    0    0     }
   "(0)+initial_delay+(1.0*pp)" { start } {   0    0    0    0     }
"(0)+initial_delay+(1.0*pp)+pp"   { end } {   0    0    0    0     }
}
