...
$tempAcq addSweptState {CDN 0 CP 0 D 0 SDN 0} {!CDN&!CP&!D&!SDN} {!CDN !CP !D !SDN}
$tempAcq addSweptState {CDN 0 CP 0 D 0 SDN 1} {!CDN&!CP&!D&SDN} {!CDN !CP !D SDN}
$tempAcq addSweptState {CDN 0 CP 0 D 1 SDN 0} {!CDN&!CP&D&!SDN} {!CDN !CP D !SDN}
$tempAcq addSweptState {CDN 0 CP 0 D 1 SDN 1} {!CDN&!CP&D&SDN} {!CDN !CP D SDN}
$tempAcq addSweptState {CDN 0 CP 1 D 0 SDN 0} {!CDN&CP&!D&!SDN} {!CDN CP !D !SDN}
$tempAcq addSweptState {CDN 0 CP 1 D 0 SDN 1} {!CDN&CP&!D&SDN} {!CDN CP !D SDN}
$tempAcq addSweptState {CDN 0 CP 1 D 1 SDN 0} {!CDN&CP&D&!SDN} {!CDN CP D !SDN}
$tempAcq addSweptState {CDN 0 CP 1 D 1 SDN 1} {!CDN&CP&D&SDN} {!CDN CP D SDN}
...
$tempWT setStimulus                       {   SDN  CP   CDN  D    Q     } {
                            "0"   { in0 } {   0    0    0    0    0     }
   "(0)+initial_delay+(1.0*pp)" { start } {   0    0    0    0    0     }
"(0)+initial_delay+(1.0*pp)+pp"   { end } {   0    0    0    0    0     }
}
