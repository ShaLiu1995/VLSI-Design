...
$tempWT setStimulus                       {   E    D    Q     } {
                            "0"   { in0 } {   1    1    1     }
   "(0)+initial_delay+(1.0*pp)" { start } {   1    1    1     }
"(0)+initial_delay+(1.0*pp)+pp"   { end } {   1    1    1     }
}

$tempWT addMeasurements {} {
  { leakage_current      leakage_power { (0)+initial_delay+(1.0*pp) (0)+initial_delay+(1.0*pp)+pp {D E} {} } NO_USER SYS }
}
