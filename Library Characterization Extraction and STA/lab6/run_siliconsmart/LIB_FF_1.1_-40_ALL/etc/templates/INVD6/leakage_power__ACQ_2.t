...
$tempWT setInterface { I ZN:out } { initial_delay units ct default_slew trailing_delay pp }

$tempWT setStimulus                       {   I    ZN    } {
                            "0"   { in0 } {   1    0     }
   "(0)+initial_delay+(1.0*pp)" { start } {   1    0     }
"(0)+initial_delay+(1.0*pp)+pp"   { end } {   1    0     }
}
...
$tempWT bindInterface { I ZN } { cell_initial_delay None[cycle_time] None[cycle_time] None[default_slew] cell_trailing_delay cell_power_period }
